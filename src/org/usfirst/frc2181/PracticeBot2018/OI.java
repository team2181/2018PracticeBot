...
public class OI {
    ...
    public JoystickButton headlightOnButton;
    public JoystickButton headlightsOffButton;
    ...
    public OI() {
        ...
        headlightsOffButton = new JoystickButton(xboxController, 7);
        headlightsOffButton.whenPressed(new headlightsOff());
        headlightOnButton = new JoystickButton(xboxController, 8);
        headlightOnButton.whenPressed(new headlightsOn());
